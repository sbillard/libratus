...
<?php
if (getOption('libratus_bottom_stats_perrow')) {
	$c = 0;

	if (getOption('libratus_bottom_stats_perrow') == 1)
		$class = 'twelve columns';
	if (getOption('libratus_bottom_stats_perrow') == 2)
		$class = 'six columns';
	if (getOption('libratus_bottom_stats_perrow') == 3)
		$class = 'four columns';
	if (getOption('libratus_bottom_stats_perrow') == 4)
		$class = 'three columns';

	if (is_numeric(getOption('libratus_bottom_stats_number'))) {
		$number = getOption('libratus_bottom_stats_number');
	} else {
		$number = 5;
	}
	?>
	<div id="bottom-modules" class="wrap clearfix">
		...
		<?php $c++;
				...
				<?php if (getOption('libratus_stats_news_latest_bottom') && class_exists('Zenpage')) { ?>
					<div class="<?php echo $class; ?>">
				...
				<?php if (getOption('libratus_stats_images_popular_bottom')) {
					if ($c == getOption('libratus_bottom_stats_perrow')) {
...
<?php
$libratus_sociallinks = false;
if ($fb_linkurl = getOption('libratus_facebook'))
	$libratus_sociallinks = true;
if ($tw_linkurl = getOption('libratus_twitter'))
	$libratus_sociallinks = true;
if ($g_linkurl = getOption('libratus_google'))
	$libratus_sociallinks = true;
	...
	<script>
		...
		var cbpBGSlideshow = (function () {
			...
			current = 0,
							...
							interval = <?php if (is_numeric(getOption('libratus_ss_interval'))) {
		echo getOption('libratus_ss_interval');
	} else {
		echo '5000';
	} ?>;
